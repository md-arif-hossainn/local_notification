...
Future<void> main() async {
  ...
  /// initialize the settings for notifications ----
  ...
  ///initialize the settings for notifications. ---
  ///“onDidReceiveLocalNotification” is for iOS versions less than 10.
  ///It will be triggered when the. app is running in foreground and when a notification is triggered.
  ///In versions less than 10, there wont be any notification appearing when it is triggered when the application is running in foreground.
